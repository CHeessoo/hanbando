...
## 📌 기능 요약
1. 회원은 국내 패키지여행에 대한 정보를 목록으로 조회하여 편하게 선택할 수 있습니다. 상세페이지를 통해 선택한 패키지 이용자의 리뷰를 확인하고, 원하는 날짜를 선택해 예약할 수 있습니다. 각각의 여행상품에 찜하기 기능 활용이 가능하며 찜목록에서 확인할 수 있습니다.
2. 회원은 국내 호텔 예약에 대한 정보를 목록으로 조회하여 편하게 선택할 수 있고, 상세페이지를 통해 원하는 날짜와 객실을 선택해 예약할 수 있습니다. 각각의 호텔상품에 찜하기 기능 활용이 가능하며 찜목록에서 확인할 수 있습니다.
3. 고객센터는 공지사항, 자주묻는 질문, 1:1 문의하기로 구성되어있으며 관리자와 회원간의 원활한 소통이 가능합니다.
4. 회원가입시 SMS 인증절차를 거칩니다. 최소한의 정보를 수집하면서도 회원에 대한 검증이 가능한 카카오, 네이버 간편로그인을 이용할 수도 있습니다.
5. 관리자는 관리자페이지에서 전체회원(일반회원, 휴면회원, 탈퇴회원) 정보에 접근하여 관리가 가능하며, 상품(패키지여행, 호텔 예약)관리 및 전체 리뷰를 조회하거나 삭제관리가 가능합니다.
6. 예약시 사용자가 정보를 입력하고 예약하면 대기상태로 진행되며 상세페이지를 통해 수정, 취소, 결제가 가능합니다. 이후, 예약목록을 통해 패키지 및 호텔예약 내용들을 확인할 수 있습니다.
