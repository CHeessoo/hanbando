...
4. 회원가입 또는 비밀번호 찾기 진행 시 SMS 문자 인증 절차 과정이 있습니다. 최소한의 정보를 수집하면서도 회원에 대한 검증이 가능한 카카오, 네이버 간편 로그인을 선택하여 이용할 수도 있습니다.
5. 회원은 마이페이지에서 개인정보, 예약 목록, 찜목록 조회 및 수정, 삭제 기능을 이용할 수 있습니다.
