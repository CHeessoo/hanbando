...
2. 회원은 국내 호텔 예약에 대한 정보를 목록으로 조회하여 편하게 확인할 수 있고, 상세페이지를 통해 원하는 날짜와 객실을 선택해서 예약할 수 있습니다. 
3. 고객센터는 공지사항, 자주 묻는 질문, 1:1 문의하기로 구성되어 있으며 관리자와 회원 간의 원활한 소통이 가능합니다.
4. 회원가입 시 SMS 문자 인증 절차 과정이 있습니다. 최소한의 정보를 수집하면서도 회원에 대한 검증이 가능한 카카오, 네이버 간편 로그인을 선택하여 이용할 수도 있습니다.
5. 회원은 마이페이지에서 개인정보를 수정하거나 
6. 관리자는 관리자 페이지에서 전체 회원(일반회원, 휴면 회원, 탈퇴 회원) 정보에 접근하여 관리가 가능하며, 상품(패키지여행, 호텔 예약) 관리 및 전체 리뷰를 조회하거나 삭제 관리를 할 수 있습니다.
7. 예약 시 사용자가 정보를 입력하고 예약하면 대기 상태로 진행되며 상세페이지를 통해 수정, 취소, 결제가 가능합니다. 이후, 예약 목록을 통해 패키지 및 호텔 예약 내용들을 확인할 수 있습니다.
...
### 개요
<img width="845" alt="기획문서(서비스개요)-이미지" src="https://github.com/CHeessoo/hanbando/assets/131851529/00122528-5628-4a32-a262-81281fd33345">
